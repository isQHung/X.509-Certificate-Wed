...
export default function DashboardLayout({
    ...
    const adminMenu = [
        ...
        {
            name: "Quản lý Root CA",
            icon: "🔑",
            path: "/dashboard/admin/root-ca",
        },
    ...
    const userMenu = [
        ...
        {
            name: "Tạo cặp khóa cá nhân",
            icon: "🔐",
            path: "/dashboard/user/keys",
        },
            ...
            <aside className="w-72 bg-white border-r border-slate-200 flex flex-col sticky top-0 h-screen">
                ...
                <div className="p-4 border-t border-slate-100">
                    ...
                    <button
                        ...
                        className="w-full mt-1 p-3 text-sm font-bold text-red-600 hover:bg-red-50 rounded-lg transition text-left flex items-center gap-3"
                    >
                        <span>🚪</span> Đăng xuất
                    </button>
                </div>
