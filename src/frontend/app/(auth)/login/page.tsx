...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.userPayload) {
        localStorage.setItem("userRole", data.userPayload.role.toUpperCase());

        localStorage.setItem("userId", data.userPayload.userId);

        localStorage.setItem("userEmail", data.userPayload.email);
      }
